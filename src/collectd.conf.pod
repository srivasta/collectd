...
=head2 Plugin C<consumption>

The I<consumption plugin> collects fine grained resource consumption
statistics for processes on the system (looking at system resources
like CPU ussage, memory consumption, and disk and network
I/O). Further, consumption can classify the processes into buckets
(uninteresting, somwhat intresting, and interesting, for example),
based on configuration, or fall back onto heuristics for
classification.
